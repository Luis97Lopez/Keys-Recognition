...
##  mascaras(5).color = "blue";
##  mascaras(5).label = "Dije";
##  mascaras(5).size = size(rgb2gray(imread('./mascaras/escenario2/dije_1.png')));
##  mascaras(5).filter = filtroC_LK(L_K, "./mascaras/escenario2/dije", 2);
##  
##  mascaras(6).color = "red";
##  mascaras(6).label = "Foto";
##  mascaras(6).size = size(rgb2gray(imread('./mascaras/escenario2/foto_1.png')));
##  mascaras(6).filter = filtroC_LK(L_K, "./mascaras/escenario2/foto", 1);
##  
##  mascaras(7).color = "green";
##  mascaras(7).label = "USB";
##  mascaras(7).size = size(rgb2gray(imread('./mascaras/escenario2/usb_1.png')));
##  mascaras(7).filter = filtroC_LK(L_K, "./mascaras/escenario2/usb", 1);
endfunction
